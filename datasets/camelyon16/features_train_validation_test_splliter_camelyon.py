...
train_images = [image.replace(".tif", ".h5") for image in train_df['image'].tolist()]
validation_images = [image.replace(".tif", ".h5") for image in val_df['image'].tolist()]
test_images = [image.replace(".tif", ".h5") for image in test_df['image'].tolist()]
